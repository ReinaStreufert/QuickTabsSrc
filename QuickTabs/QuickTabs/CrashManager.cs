...
namespace QuickTabs
{
    internal static class CrashManager
    {
        ...
        private const string dtFormat = "MM-dd-yy-HH-mm-ss";
        ...
        public static void Initialize()
        {
            ...
            string qtData = Settings.QuickTabsDataDir; // getter for this already make sure the dir exists.
        ...
        public static void FlushReport()
        {
            ...
            {
                string qtData = Settings.QuickTabsDataDir;
